...
<body>
	<header>
      ...
      <div class="logo">
        <img width="250" height="100" src="images/logo.jpg" alt="logo">
          ...
          <div class="login">
            <ul>
              <li><a href="usrprofile.php">Profile</a></li>
  ...
  <section class="about-us-section">
    <div class="container">
      ...
      <a href="aboutus2.html" class="cta-btn">Learn More</a>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="product-grid">
        <div class="product-item">
          ...
          <h3>Red Snapper</h3>
          <p>$12.99/lb</p>
          <a href="products.php" class="buy-btn">Buy Now</a>
        </div>
        <div class="product-item">
      ...
      <a href="products.php" class="cta-btn">View All Products</a>
    </div>
  </section>
